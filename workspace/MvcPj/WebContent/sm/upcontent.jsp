...
<%
		Board upSelCon = (Board) request.getAttribute("upSelCon");
%>
<head>
<meta charset=utf-8>
...
<h3> Simple Board with jsp and dbcp in MVC</h3>
...
<input type="hidden" name="seq" value="<%=upSelCon.getSeq()%>">
<table border=0 width=600 align=center cellpadding=3 cellspacing=1 bordercolor=gray>
<tr>
<td width=30% align=center>WRITER</td>
<td><input type=text name=writer value="<%=upSelCon.getWriter()%>" size=60></td>
</tr>
<tr>
<td align=center>EMAIL</td>
<td><input type=text name=email value="<%=upSelCon.getEmail()%>" size=60></td>
</tr>
<tr>
<td align=center>SUBJECT</td>
<td><input type=text name=subject value="<%=upSelCon.getSubject()%>" size=60></td>
</tr>
<tr>
<td align=center>CONTENT</td>
<td><textarea id=ta name=content style=width:98% rows=8 cols=60><%=upSelCon.getContent()%></textarea></td>
</tr>
<tr>
