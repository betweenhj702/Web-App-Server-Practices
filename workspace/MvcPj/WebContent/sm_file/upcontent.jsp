...
<form name=input method=post action=sm.do?m=update enctype="multipart/form-data">
...
<td><input type=text name=email value="${selUpCon.email}" size=60></td>
</tr>
<tr>
<td align=center>SUBJECT</td>
<td><input type=text name=subject value="${selUpCon.subject}" size=60></td>
</tr>
<tr>
...
<td><textarea id=ta name=content style=width:98% rows=8 cols=60>${selUpCon.content}</textarea></td>
</tr>
<tr>
