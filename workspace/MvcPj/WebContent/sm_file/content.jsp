...
<h2>Simple Board with FILE in MVC </h2>
&nbsp;&nbsp;&nbsp;
...
<td>
	<a href='sm.do?m=download&fname=${selectCon.fname}'>${selectCon.fname}</a>
	&nbsp;&nbsp;&nbsp;${selectCon.fsize} Bytes</td>
</tr>
<tr>
...
|
<a href='sm.do?m=delete&seq=${selectCon.seq}&fname=${selectCon.fname}'>삭제</a>
|
<a href='sm.do'>목록</a>
</b>
<hr width='600' size='2' noshade>
