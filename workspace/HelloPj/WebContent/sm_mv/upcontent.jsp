...
<h3> Simple Board with jsp and dbcp in MODEL1</h3>
...
<td><input type=text name=writer value="<%=dto.writer%>" size=60></td>
</tr>
<tr>
<td align=center>EMAIL</td>
<td><input type=text name=email value="<%=dto.email%>" size=60></td>
</tr>
<tr>
<td align=center>SUBJECT</td>
<td><input type=text name=subject value="<%=dto.subject%>" size=60></td>
</tr>
<tr>
<td align=center>CONTENT</td>
<td><textarea id=ta name=content style=width:98% rows=8 cols=60><%=dto.content%></textarea></td>
</tr>
<tr>
